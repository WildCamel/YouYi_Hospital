...
var ui_cms = new function() { 
	...
	this.CmsLogin1Page_to_html = function(comp){
		...
		page.content = nano('<form method="post" action="./index.php?m=webapp_member&c=index&a=login" id="myform" data-submit="login1_callback(response)">\
									...
									<div class="chelogin"><div class="chebox"><input type="checkbox" name="cookietime" value="3110400" checked="true" id="cookietime" />记住密码</div><div class="chebox"><a href="index.php?m=webapp_member&c=index&a=public_forget_password_mobile&siteid=1">忘记密码？</a></div></div>\
